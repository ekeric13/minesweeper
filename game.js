// Game Logic Taken Heavily from http://kilon.org/samples/minesweeper.html
// Credit goes to Uzi Kilon
...
Cell.prototype.setValue = function(value){
    ...
    el.removeClass('mark').html(value === 0 ? "" : value);
    console.log()
    switch(value) {
        case 1:
            el.addClass('one');
...
var Game = {
    ...
    start: function(options){
        options = options || {};
        var pat = /\D/;
        var numBombs = 10, colls = 8, rows = 8;
